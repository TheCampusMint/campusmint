...
export default async function PublicProfileRoute({ params }: { params: Promise<{ username: string }> }) {
  ...
  const university = universities[profileUser.account.universityId];
