...
export function MessagesSkeleton({ viewer, theme, profiles }: { viewer: CampusMintUser; theme: UniversityTheme; profiles: ProfilesState }) {
  ...
  return (
    <div className="space-y-5"><div className="px-1"><p className="text-[10px] font-black uppercase tracking-[0.22em] text-slate-400">Private conversations</p><h1 className="mt-1 text-3xl font-black text-slate-950">Direct Mint</h1></div>
